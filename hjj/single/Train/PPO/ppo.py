...
H_NEURONS2 = 16
LR_GAMMA = 0.99999
file_to_load = "/home/hjj/exp_test/Test/TestCode/save_net/ppo_new.h5"
# actorloss_out_file_path = "/home/hjj/single/Train/train_data/ppo_actorloss.txt"
# actorloss_out_file = open(actorloss_out_file_path, 'w')
# criticloss_out_file_path = "/home/hjj/single/Train/train_data/ppo_criticloss.txt"
# criticloss_out_file = open(criticloss_out_file_path, 'w')
...
class PPO:
    ...
    def learn(self, s, a, r, s_):
        ...
        print(self.cur_log_dist.log_prob(action))
        ...
        print("#######################actor_loss:    {:.8f}#####################\n".format(actor_loss))
        # actorloss_out_file.write(format(actor_loss))
        # actorloss_out_file.flush()
        ...
        # criticloss_out_file.write(format(critic_loss))
        # criticloss_out_file.flush()
