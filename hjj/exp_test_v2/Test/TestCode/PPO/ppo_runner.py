...
def main():
    ...
    traffic_data.to_csv("/home/hjj/exp_test_v2/Test/TestData/real/ppo_real.csv")
    collect_tripinfo(trip_file,'/home/hjj/exp_test_v2/Test/TestData/real/ppo_real')
