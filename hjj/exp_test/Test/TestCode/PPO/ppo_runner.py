...
def main():
    ...
    traffic_data.to_csv("/home/hjj/exp_test/Test/TestData/vvlow/ppo/interval30/ppo_vvlow_30.csv")
    collect_tripinfo(trip_file,'/home/hjj/exp_test/Test/TestData/vvlow/ppo/interval30/ppo_vvlow_30')
