...
def main():
    ...
    traffic_data.to_csv("/home/hjj/exp_test/Test/TestData/vvlow/dqn/interval30/dqn_vvlow_30.csv")
    collect_tripinfo(trip_file,'/home/hjj/exp_test/Test/TestData/vvlow/dqn/interval30/dqn_vvlow_30')
