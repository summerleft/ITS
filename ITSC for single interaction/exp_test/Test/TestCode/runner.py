...
def main():
    ...
    traffic_data.to_csv("/home/hjj/exp_test/Test/TestData/vvlow/static/interval10/static_vvlow_10.csv")
    traci.close()
    collect_tripinfo(trip_file,'/home/hjj/exp_test/Test/TestData/vvlow/static/interval10/static_vvlow_10')
    # 两个文件
