...
#from utils import save_multi_agents

# save
save_path = "/home/hjj/single_retrain/Train/save_net/dqn/act.h5"
save_path_best = "/home/hjj/single_retrain/Train/save_net/dqn/best.h5"
out_file_path = "/home/hjj/single_retrain/Train/save_net/dqn/output.txt"
...
def main():
    ...
    for epoch in range(TOTAL_EPOCH):
        ...
        while simulation_steps < SIM_STEPS:
            ...
            print("Simulation {}: avg_wait_time_30 {}, reward_30 {} , reward_epoch {}\n"
                        .format(simulation_steps, avg_wait_time, reward, total_reward))
    ...
    df.to_csv('/home/hjj/single_retrain/Train/dqn_retrain.csv')
...
if __name__ == '__main__':
    ...
    sumoConfig = "/home/hjj/single_retrain/sumo_data/single_cross.sumocfg"
